...
export default function LoginPage() {
  ...
  const inputClass =
    ...
    'border-[#ece5e5] bg-[#faf8f7] text-[#1b1517] placeholder:text-[#a19698] ' +
    'focus:border-[#e11d1d] focus:bg-white focus:ring-[3px] focus:ring-[#e11d1d]/14'

  return (
    <div className="min-h-screen flex relative overflow-hidden" style={{ backgroundColor: '#faf8f7' }}>
      ...
      <div className="hidden lg:flex w-[54%] flex-col justify-between p-12 relative z-10">
        <div className="flex items-center gap-3">
          ...
          <span className="font-semibold text-base" style={{ color: '#1b1517' }}>МОСТОВОЙ CRM</span>
        </div>

        <div>
          <div
            className="flex items-center gap-2 uppercase"
            style={{ color: '#c01818', fontSize: 12, fontWeight: 800, letterSpacing: '0.13em' }}
          >
          ...
          <p style={{ margin: 0, maxWidth: 440, color: '#574d4f', fontSize: 15, lineHeight: 1.65 }}>
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    background: 'rgba(225,29,29,0.10)', color: '#e11d1d',
                  }}
                >
                  <Icon className="w-[19px] h-[19px]" />
                </div>
                <div className="min-w-0">
                  <p className="text-sm font-semibold truncate" style={{ color: '#1b1517' }}>{label}</p>
                  <p className="text-xs truncate" style={{ color: '#7d7174' }}>{desc}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <p className="text-xs" style={{ color: '#6b6063' }}>© 2026 МОСТОВОЙ. Все права защищены.</p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 relative z-10">
        <div className="w-full max-w-sm">
          ...
          <div className="lg:hidden flex items-center gap-3 mb-8">
            <div className="w-9 h-9 brand-mark flex-shrink-0" aria-hidden />
            <span className="font-semibold" style={{ color: '#1b1517' }}>МОСТОВОЙ CRM</span>
          </div>
          ...
          >
            <h1 style={{ fontSize: 25, fontWeight: 700, color: '#1b1517', letterSpacing: '-0.03em' }}>
              Войти в систему
            </h1>
            <p className="text-sm mb-7" style={{ color: '#7d7174', marginTop: 4 }}>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div className="space-y-1.5">
                <Label
                  className="uppercase"
                  style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.1em', color: '#574d4f' }}
                >
                  Email
                </Label>
              ...
              <button
                ...
                style={{
                  // Белый текст: на #ff5c68 он даёт 2.84:1, поэтому градиент
                  // уходит в тёмную сторону красного (#cc1414 → 5.71:1).
                  background: 'linear-gradient(135deg, #e11d1d, #cc1414)',
                  borderRadius: 12,
